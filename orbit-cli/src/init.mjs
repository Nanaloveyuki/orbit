...
function applicationFiles({ slug, name, identifier, moduleName, orbitVersion, cliVersion }) {
  ...
  return new Map([
    ...
    [".github/workflows/windows-release.yml", [
      ...
      "          $toolchain",
      "          if (-not ($toolchain | Select-String -Pattern '^moonc v0\\.10\\.9')) {",
      "            throw \"MoonBit v0.10.9 is required\"",
      "          }",
    ...
    ["docs/windows-release.md", [
      ...
      "2. Select an installer-supported MoonBit channel in `.moon-version`. For a",
      "   release, record `moon version --all` and verify the required compiler.",
